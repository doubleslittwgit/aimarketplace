...
export const metadata: Metadata = {
  title: "お問い合わせ",
  description: "BuildBayへのお問い合わせ窓口。",
};
  ...
  return (
    <>
      ...
      <div className="my-8 rounded-xl border border-border bg-surface p-6">
        <p className="mb-1 text-[13px] text-text-muted">メールアドレス</p>
        <p className="font-mono text-lg text-text-primary">{CONTACT_EMAIL}</p>
      </div>
      ...
      <ul>
        ...
        <li>
          特定のツールに関するお問い合わせの場合は、ツール名またはページのURLをお知らせください
        </li>
        <li>
          不具合のご報告は、お使いのOS・ブラウザと、発生時の状況を添えていただけると助かります
        </li>
      </ul>
